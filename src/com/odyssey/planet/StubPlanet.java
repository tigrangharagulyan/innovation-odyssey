...
public final class StubPlanet implements PlanetDefinition {
    private final String id;

    public StubPlanet(String id) { this.id = id; }
    ...
    @Override public float[] cpEnergies()   { return new float[]{2_000f, 10_000f, 50_000f, 100_000f}; }
    @Override public float[]  milestoneRpms()  { return new float[]{5.25f, 3.5f, 6.75f, 7.5f, 9.5f, 99f}; }
    @Override public String[] milestoneNames() { return new String[]{"Elastic Walls","Speed Keep","Wall ×3","Hit ×2","Bumper ×3","-"}; }
    @Override public String[] milestoneDescs() {
        return new String[]{
            "Interns bounce off walls harder",
            "Interns keep 97% speed after every hit",
            "Each wall touch earns 3x more Space Points",
            "Intern-intern hits earn 2x more Space Points",
            "Bumpers deal 3x more Space Points per hit",
            "-"
        };
    }
